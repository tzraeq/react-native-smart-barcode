...
RCT_EXPORT_METHOD(readerQR:(NSString *)fileUrl resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
  dispatch_sync(dispatch_get_main_queue(), ^{
    ...
    if(result){
      ...
      NSError *error = [NSError errorWithDomain:domain
                                           code:404
                                       userInfo:userInfo];*/
      reject(@"404",@"No QR Code found",nil);
    }
  });
